...
IF StrLowCase(!version.os_family) EQ 'unix' THEN data_directory=rootdir('mwa')+filepath('',root='DATA',subdir=['128T','Drift_June']) $
    ELSE data_directory=rootdir('mwa')+filepath('',root='DATA3',subdir=['128T','Drift_June'])

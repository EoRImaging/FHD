pro eor_firstpass_enterprise,obs_id,output_directory,version
except=!except
!except=0
heap_gc
...
;	max_cal_baseline=400
   ...
   'apb_test_diffuse_subtract_1':begin
      diffuse_model='/data4/MWA/beards_FHD/diffuse_model_1.sav'
      model_visibilities=1
      calibration_visibilities_subtract=0
      return_cal_visibilities=1
      snapshot_healpix_export=0
...
data_dir='/data4/MWA/EoRuvfits/jd2456528v4_1/'
vis_file_list=data_dir+number_formatter(obs_id)+'.uvfits'

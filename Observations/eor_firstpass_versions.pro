...
;	max_cal_baseline=400
  ...
  'nb_bandpass_division_test': begin
   ...
   'nb_twopolyquad_extrafancy_x2fix_meanphase':begin 
       saved_run_twopoly_meanmode=1
   end
   'nb_twopolyquad_extrafancy_meanphase_compareupdate':begin 
       saved_run_twopoly_meanmode=1
   end
   ...
   'nb_sim_perfect_cal_noeor_ones_maxcalsources_nod_zenithpointing_notileflag':begin 
      ...
      cable_bandpass_fit=0
      turn_off_visflagbasic=1
      cal_sim_input='fhd_nb_sim_perfect_cal_noeor_ones_maxcalsources_nod_zenithpointing_notileflag_modelmake10'
      no_frequency_flagging=1
      perfect_cal_ones=1
      remove_eor=1
      flag_calibration=0
      ...
      cable_bandpass_fit=0
      turn_off_visflagbasic=1
      cal_sim_input='fhd_nb_sim_perfect_cal_noeor_ones_maxcalsources_nod_zenithpointing_notileflag_modelmake10_double'
      no_frequency_flagging=1
      double=1
      perfect_cal_ones=1
      remove_eor=1
  ...
  'nb_realdata_transfer_cal_beamperchannel_eor_enhance':begin 
      ...
      nfreq_avg=1
      real_data_add_eor=1
      transfer_calibration='/nfs/mwa-09/r1/djc/EoR2013/Aug23/fhd_nb_devel_June2015/calibration/1061316176_cal.sav'
   end
   'nb_realdata_overfit_cal_beamperchannel_noeor':begin 
      saved_run_bp=0
      cable_bandpass_fit=0
      over_calibrate=1
      nfreq_avg=1
      ...
      'nb_realdata_overfit_transfer_cal_beamperchannel_eor_enhance':begin 
      saved_run_bp=0
      cable_bandpass_fit=0
      over_calibrate=1
      nfreq_avg=1
      real_data_add_eor=1
      transfer_calibration='/nfs/mwa-09/r1/djc/EoR2013/Aug23/fhd_nb_realdata_overfit_cal_beamperchannel_noeor/calibration/1061316176_cal.sav'
   end

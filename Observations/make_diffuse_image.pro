PRO make_diffuse_image,cleanup=cleanup,ps_export=ps_export,recalculate_all=recalculate_all,export_images=export_images,version=version,$
...
general_obs,cleanup=cleanup,ps_export=ps_export,recalculate_all=recalculate_all,export_images=export_images,version=version,$
    ...
    n_avg=n_avg,ps_kbinsize=ps_kbinsize,ps_kspan=ps_kspan,restrict_hpx_inds=restrict_hpx_inds,nside=nside,_Extra=extra
!except=except
END
PRO paper_lst_bin_test,recalculate_all=recalculate_all,export_images=export_images,version=version,_Extra=extra
except=!except
!except=0 
heap_gc
...
IF StrLowCase(!version.os_family) EQ 'unix' THEN data_directory='/data2/PAPER/psa32/' $
    ELSE data_directory=rootdir('mwa')+filepath('',root='PAPER_DATA',subdir=['lst_bin_test'])

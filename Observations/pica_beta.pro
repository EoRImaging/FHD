...
IF channel LE 0 THEN data_directory=rootdir('mwa')+filepath('',root='DATA2',subdir=['Beta','PicA']) $
    ELSE data_directory=rootdir('mwa')+filepath('',root='DATA2',subdir=['Beta','PicA',Strn(Floor(channel))])

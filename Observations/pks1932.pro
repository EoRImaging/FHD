...
IF i EQ 0 THEN CONTINUE
    IF i EQ 0 THEN data_directory=filepath('',root='DATA2',subdir=['Beta','PKS1932']) ELSE data_directory=filepath('',root='DATA2',subdir=['Gamma','PKS1932'])
    ;data_directory=filepath('',root='DATA2',subdir=['Gamma','PKS1932'])

PRO TwoSecTest,cleanup=cleanup,ps_export=ps_export,recalculate_all=recalculate_all,export_images=export_images,version=version,$
...
data_directory=rootdir('mwa')+filepath('',root='DATA3',subdir=['128T','TwoSecTest'])

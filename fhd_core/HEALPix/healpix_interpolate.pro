FUNCTION healpix_interpolate,healpix_map,obs,nside=nside,hpx_inds=hpx_inds,from_kelvin=from_kelvin,$
    from_jy_per_sr=from_jy_per_sr,hpx_ordering=hpx_ordering,coord_sys=coord_sys,Jdate_use=Jdate_use,_Extra=extra
...
apply_astrometry, obs, ra_arr=pix_ra, dec_arr=pix_dec, x_arr=xv_hpx, y_arr=yv_hpx, /ad2xy, _Extra=extra

FUNCTION beam_image_cube,obs,psf,freq_i_arr=freq_i_arr,pol_i_arr=pol_i_arr,$
  ...
  FOR p_i=0,n_pol-1 DO FOR fb_i=0L,n_freq_use-1 DO BEGIN
    ...
    FOR b_i=0,bin_n[fb_i]-1 DO begin
      ;save, file='/nfs/mwa-09/r1/djc/EoR2013/Aug23/fhd_nb_sim_perfect_cal_eor_ones_maxcalsources_farextent2_nod/1061316176_beam_arr_' $
      ;  +strtrim(p_i,2)+'_'+strtrim(f_i_i[b_i],2)+'.sav', beam_single
      ;print, 'hi' 
      beam_arr[p_i,f_i_i[b_i]]=Ptr_new(beam_single)
    endfor

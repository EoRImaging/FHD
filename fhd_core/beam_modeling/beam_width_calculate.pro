FUNCTION beam_width_calculate,obs,min_restored_beam_width=min_restored_beam_width,$
    max_restored_beam_width=max_restored_beam_width,fwhm=fwhm,area_return=area_return,$
...
IF Keyword_Set(max_restored_beam_width) THEN beam_width=beam_width<max_restored_beam_width

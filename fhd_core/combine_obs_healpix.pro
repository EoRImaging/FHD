...
;    yvals=meshgrid(dimension,elements,2)-elements/2
    ...
    hpx_inds1=hpx_cnv.inds ;note: these indices are restricted to be monotonic increasing
...
;                mrc_image=source_image_generate(mrc_cat,obs,pol_i=4,resolution=16,dimension=dimension,$

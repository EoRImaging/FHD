PRO fhd_main, file_path_vis, status_str, export_images=export_images, cleanup=cleanup, recalculate_all=recalculate_all,$
    ...
    nofreqdepbeam=nofreqdepbeam,tenthgrid=tenthgrid,fifteenthgrid_orig=fifteenthgrid_orig,fifteenthgrid_beamres=fifteenthgrid_beamres,thirtygrid=thirtygrid,_Extra=extra

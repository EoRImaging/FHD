...
IF (x_offset+1 EQ resolution) AND (y_offset+1 EQ resolution) THEN BEGIN
    kernel_1_0=reform(shift(reform(kernel_1_0,resolution,resolution),1,0),resolution^2.)
    kernel_0_1=reform(shift(reform(kernel_0_1,resolution,resolution),0,1),resolution^2.)
    kernel_1_1=reform(shift(reform(kernel_1_1,resolution,resolution),1,1),resolution^2.)
ENDIF ELSE IF (x_offset+1 EQ resolution) THEN BEGIN
    kernel_1_0=reform(shift(reform(kernel_1_0,resolution,resolution),1,0),resolution^2.)
    kernel_1_1=reform(shift(reform(kernel_1_1,resolution,resolution),1,0),resolution^2.)
ENDIF ELSE IF (y_offset+1 EQ resolution) THEN BEGIN
    kernel_0_1=reform(shift(reform(kernel_0_1,resolution,resolution),0,1),resolution^2.)
    kernel_1_1=reform(shift(reform(kernel_1_1,resolution,resolution),0,1),resolution^2.)
ENDIF

...
FUNCTION uvh5_read_layout, file_path_vis, _EXTRA=extra
    ...
    ; are ECEF positions relative to telescope.location.
    layout = {n_antenna:nant, antenna_names:ant_names, antenna_numbers:ant_numbers, $
        antenna_positions:ant_positions, latitude:latitude, longitude:longitude, $
        altitude:altitude, telescope_name:telescope_name}

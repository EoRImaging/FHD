...
PRO uvfits2fhd,file_path_vis,status_str,export_images=export_images,cleanup=cleanup,recalculate_all=recalculate_all,$
    ...
    transfer_flags=transfer_flags,flag_calibration=flag_calibration, production=production,cal_sim=cal_sim,remove_eor=remove_eor,$
    enhance_eor=enhance_eor,turn_off_visflagbasic=turn_off_visflagbasic,input_unflagged=input_unflagged,bubbles=bubbles,$
    real_data_add_eor=real_data_add_eor,no_diffuse=no_diffuse,_Extra=extra
  ...
  IF data_flag LE 0 THEN BEGIN
    ...
    ;jones=getvar_savefile('/nfs/mwa-09/r1/djc/EoR2013/Aug23/fhd_nb_sim_overfit_cal_beamperchannel_novisflagbasic_modelnoflag_noeor_beamperchannelforreal/beams/1061316176_jones.sav','jones')
    ;End

...
;-
PRO vis_flag,vis_arr,flag_ptr,obs,psf,params,flag_nsigma=flag_nsigma,flag_sparse_uv_coverage=flag_sparse_uv_coverage,no_tile_vis_flagging=no_tile_vis_flagging,_Extra=extra
  ...
  if ~keyword_set(no_tile_vis_flagging) then begin ;my option

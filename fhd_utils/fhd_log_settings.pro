...
IF overwrite_test THEN BEGIN
    ...
    IF Min([cmd_i,obs_i,psf_i,cal_i,fhd_i,end_i]) GE 0 THEN BEGIN
...
info_out=[[info_out],[cmd_insert],[obs_insert],[psf_insert],[cal_insert],[fhd_insert],[end_delimiter,filler]]

...
CASE beam_model_version OF
    ...
    2: BEGIN
        ...
        FOR beam_i=0, 3 do begin
            ...
            FOR freq_i=0,nfreq_bin-1 DO BEGIN
                ...
                hera_beam_grid_arr = healpix_interpolate(real_part(hera_beam_interp[beam_pix[*,beam_i],freq_i]),obs,nside=nside,Jdate_use=Jdate_use,coord_sys='equatorial',/ignore_refraction) $
                  + Complex(0,1) * healpix_interpolate(imaginary(hera_beam_interp[beam_pix[*,beam_i],freq_i]),obs,nside=nside,Jdate_use=Jdate_use,coord_sys='equatorial',/ignore_refraction) 
    ...
    ELSE: BEGIN
        ...
        FOR pol_i=0,1 DO BEGIN
            ...
            hera_beam_grid_arr=healpix_interpolate(hera_beam_interp_arr,obs,nside=nside,Jdate_use=Jdate_use,coord_sys='equatorial',/ignore_refraction)

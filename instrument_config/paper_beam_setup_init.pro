...
IF N_Elements(antenna_size) EQ 0 THEN antenna_size=Sqrt(5.5) ;meters (conversation with Jonnie Pober)
antenna_height=0.5 ;meters (conversation with Jonnie Pober)
velocity_factor=0.673 ;use MWA number

PRO array_simulator,vis_arr,vis_weights,obs,status_str,psf,params,jones,error=error,$
    ...
    eor_sim=eor_sim, include_noise = include_noise, hpx_select_radius=hpx_select_radius, select_radius_multiplier=select_radius_multiplier, $
  ...
  IF ~Keyword_set(hpx_select_radius) THEN BEGIN
      hpx_select_radius = primary_beam_radius(obs,psf,beam_threshold=beam_threshold,select_radius_multiplier=select_radius_multiplier,_Extra=extra)
  ENDIF
  select_radius = hpx_select_radius

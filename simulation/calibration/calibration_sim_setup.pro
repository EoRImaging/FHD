PRO calibration_sim_setup, cal_sim_input, vis_arr, vis_weights, enhance_eor=enhance_eor, remove_eor=remove_eor,bubbles=bubbles, file_path_vis=file_path_vis, $
	...
	IF ~keyword_set(vis_XX_model) OR ~keyword_set(vis_YY_model) then message, '/nfs/mwa-03/r1/EoR2013/'+cal_sim_input+'/'+obs_id+'_vis_model_arr.sav not found or did not contain specified variable'

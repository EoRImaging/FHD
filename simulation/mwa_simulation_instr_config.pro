...
lon=116.67081524 ;degrees (MWA, from Tingay et al. 2013)
lat=-26.7033194 ;degrees (MWA, from Tingay et al. 2013)
alt=377.827 ;altitude (meters) (MWA, from Tingay et al. 2013)
END
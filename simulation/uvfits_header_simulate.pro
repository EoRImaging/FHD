PRO uvfits_header_simulate,nbaselines=nbaselines,n_tile=n_tile,n_pol=n_pol,n_freq=n_freq,date_obs=date_obs,jd0=Jdate0,$
    frequency_resolution=frequency_resolution,frequency_array=frequency_array,reference_frequency=reference_frequency,ref_freq_i=ref_freq_i,$

...
ENDIF ELSE BEGIN
    ...
    Call_Procedure,inst_settings_fn,n_tile=n_tile,n_pol=n_pol,n_freq=n_freq,frequency_resolution=frequency_resolution,$
        time_resolution=time_resolution,time_integration=time_integration,reference_frequency=reference_frequency
ENDELSE
